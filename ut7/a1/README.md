...
``Que la sesión expira en 5 minutos y 0 segundos``
...
``Se borra toda la configuración que haga, ya que el router no tendra una configuración de inicio.``

**Paso 3.  Verificar la conectividad de la red**

1. Haga ping a la PC-B en un símbolo del sistema en la PC-A. 

**Nota:** Es necesario deshabilitar el firewall de los PCs.
...
``Con la letra C se indica que ya esta comunicada una subred.``
...
| :---    | :----    | :---    | :---    | :----    |
|1800|FastEthernet 0/0 (Fa0/0)|Fast Ethernet 0/1 (F0/1)|Serial 0/0/0 (S0/0/0)|Serial 0/0/1 (S0/0/1)|
|1900|GigabitEthernet 0/0 (G0/0)|Gigabit Ethernet 0/1 (G0/1)|Serial 0/0/0 (S0/0/0)|Serial 0/0/1 (S0/0/1)|
|2801|FastEthernet 0/0 (Fa0/0)|Fast Ethernet 0/1 (F0/1)|Serial 0/1/0 (S0/1/0)|Serial 0/1/1 (S0/1/1)|
|2811|FastEthernet 0/0 (Fa0/0)|Fast Ethernet 0/1 (F0/1)|Serial 0/0/0 (S0/0/0)|Serial 0/0/1 (S0/0/1)|
